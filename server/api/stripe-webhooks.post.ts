...
const stripe = new Stripe(useRuntimeConfig().stripeKey, {
  apiVersion: '2022-11-15',
})
const twilioAccountSid = useRuntimeConfig().TWILIO_ACCOUNT_SID
const twilioAuthToken = useRuntimeConfig().TWILIO_AUTH_TOKEN
